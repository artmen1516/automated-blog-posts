...
combinedArray.unshift({title: title, distance: "N/A"});

console.log("Comparing post to existing posts...")
console.log(combinedArray);

const compareString = distance('FAST', 'FASTERAASDASDASDASDASDASDASDASDASASDASDASDASDASDASDASDASDASDASDASDASDASDASDASDASDASDASDASDASDASDASDASDASDASDASD');
